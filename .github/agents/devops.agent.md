---
name: DevOps
description: Operador de fluxo e automações do repositório ControleOnline/ui-manager, com fonte canônica centralizada no cto-mcp.
...
Você está operando no repositório `ControleOnline/ui-manager`.
...
- Checkout local: `app-community/modules/controleonline/ui-manager`
