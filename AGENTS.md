...
- Helpers de formatacao/normalizacao usados pela rota devem vir de `@controleonline/ui-common/src/utils/formatter`; nao criar formatter local dentro do `ui-manager`.
