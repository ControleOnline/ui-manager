...
test.describe('my companies browser smoke', () => {
  test('opens the shared people list for linked companies', async ({page}) => {
    await mockAdminApi(page);

    await page.goto('/my-companies-page');

    await expect(page.getByText('LAGOA BRANCA', {exact: true})).toBeVisible({
      timeout: 15000,
    });
    await expect(page.getByText('LAGOA BRANCA LTDA', {exact: true})).toBeVisible();
  });
});
