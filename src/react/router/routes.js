...
import PdvPage from '@controleonline/ui-orders/src/react/pages/PdvPage';
...
import PrinterDeviceDetailPage from '@controleonline/ui-common/src/react/pages/PrinterDeviceDetailPage';
import PrinterDeviceFormPage from '@controleonline/ui-common/src/react/pages/PrinterDeviceFormPage';
import ConfiguratorPage from '@controleonline/ui-config/src/react/pages/ConfiguratorPage';
import ThemeManagerPage from '@controleonline/ui-layout/src/react/pages/ThemeManagerPage';
...
import DeliveryRateHistoryPage from '@controleonline/ui-logistic/src/react/pages/delivery-rates/DeliveryRateHistoryPage';
import DeliveryRateCompanyPage from '@controleonline/ui-logistic/src/react/pages/delivery-rates/DeliveryRateCompanyPage';
import DeliveryPresenceInboxPage from '@controleonline/ui-logistic/src/react/pages/presence/DeliveryPresenceInboxPage';
import DeliveryPresenceDetailPage from '@controleonline/ui-logistic/src/react/pages/presence/DeliveryPresenceDetailPage';
import DeliveryPresenceHistoryPage from '@controleonline/ui-logistic/src/react/pages/presence/DeliveryPresenceHistoryPage';
import {
  IP_CAMERA_DEVICE_TYPE,
  PRINT_DEVICE_TYPE,
} from '@controleonline/ui-common/src/react/utils/printerDevices';
import ConnectionsPage from '@controleonline/ui-common/src/react/pages/Connections';
import FinancialHubPage from '@controleonline/ui-financial/src/react/pages/FinancialHubPage';
import MarketplaceIntegrationPage from '@controleonline/ui-common/src/react/pages/MarketplaceIntegrationPage';
import IntegrationConfigPage from '@controleonline/ui-common/src/react/pages/IntegrationConfigPage';
import IntegrationsPage from '@controleonline/ui-common/src/react/pages/Integrations';
import ManagerCategoriesPage from '@controleonline/ui-products/src/react/pages/ManagerCategoriesPage';
import MenuCostsPage from '@controleonline/ui-products/src/react/pages/MenuCostsPage';
import MenuCostsParametersPage from '@controleonline/ui-products/src/react/pages/MenuCostsParametersPage';
import MenuCostsIngredientsPage from '@controleonline/ui-products/src/react/pages/MenuCostsIngredientsPage';
import MenuCostsPackagingPage from '@controleonline/ui-products/src/react/pages/MenuCostsPackagingPage';
import MenuCostsResalePage from '@controleonline/ui-products/src/react/pages/MenuCostsResalePage';
import MenuCostsSuppliersPage from '@controleonline/ui-products/src/react/pages/MenuCostsSuppliersPage';
import MenuCostsPurchasesPage from '@controleonline/ui-products/src/react/pages/MenuCostsPurchasesPage';
import MenuAccessConfigPage from '@controleonline/ui-config/src/react/pages/MenuAccessConfigPage';
