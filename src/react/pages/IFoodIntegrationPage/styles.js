...
const styles = StyleSheet.create({
  ...
  interruptionHeader: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', gap: 8 },
  interruptionText: { color: '#78350F', fontSize: 12, fontWeight: '700' },
  interruptionMeta: { color: '#92400E', fontSize: 11, lineHeight: 15 },
  interruptionRemoveButton: { width: 28, height: 28, borderRadius: 8, borderWidth: 1, borderColor: '#FECACA', backgroundColor: '#FEF2F2', alignItems: 'center', justifyContent: 'center' },
  interruptionForm: { borderRadius: 12, borderWidth: 1, borderColor: '#E2E8F0', backgroundColor: '#F8FAFC', paddingHorizontal: 12, paddingVertical: 10, gap: 8 },
  ...
  hoursShiftAddBtn:  { alignSelf: 'flex-start', flexDirection: 'row', alignItems: 'center', gap: 4, paddingVertical: 4 },
  hoursShiftAddText: { fontSize: 12, fontWeight: '700', color: '#0EA5E9' },
  hoursShiftRemoveBtn: { width: 28, height: 28, borderRadius: 8, borderWidth: 1, borderColor: '#FECACA', alignItems: 'center', justifyContent: 'center', backgroundColor: '#FEF2F2' },
