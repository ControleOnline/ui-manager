...
import { ActivityIndicator, Image, Platform, RefreshControl, ScrollView, Text, TextInput, TouchableOpacity, View } from 'react-native';
...
import styles from './IFoodIntegrationPage.styles';
...
import {
  ...
  inlineStyle_1055_32,
  inlineStyle_1104_22,
} from './IFoodIntegrationPage.styles';
          ...
          <View style={[styles.sectionCard, shadowStyle]}>
            ...
            {!hoursLoading && !hoursEditing && (
              Array.isArray(hours) && hours.length > 0 ? (
                <View style={inlineStyle_1013_22}>
                  {DAY_ORDER.map(day => {
                    ...
                    return (
                      <View key={day} style={styles.hoursDayRow}>
                        ...
                        <View style={inlineStyle_1020_30}>
                          {isOpen
            ...
            {hoursEditing && Array.isArray(hoursDraft) && (
              hoursDraft.length > 0 ? (
                <View style={inlineStyle_1041_22}>
                  {DAY_ORDER.map(day => {
                    ...
                    return (
                      <View key={day} style={[styles.hoursDayRow, { alignItems: 'center' }]}>
                        ...
                        {entry.open ? (
                          <View style={inlineStyle_1055_32}>
                            {(entry.shifts || []).map((s, i) => (
                ...
                <View style={inlineStyle_1104_22}>
                  <View style={styles.helperRow}>
                    <Text style={styles.helperText}>
                      ...
                      <View style={styles.productContent}>
                        <View style={styles.productTitleRow}>
                          ...
                          {published && itemId ? (
                            <TouchableOpacity
                              activeOpacity={0.8}
                              onPressIn={markNextProductCardPressAsHandled}
                            ...
                            {editingPrice ? (
                              <>
                                <TextInput
                                  ...
                                  onFocus={markNextProductCardPressAsHandled}
